...
description: "Tokens live in one source of truth: semantic names point at primitives, not raw values. That stays abstract until you move one. Change a decision and watch it propagate through every component at once."
date: 2026-06-28
tool: TokenPlayground
kind: Playground
order: 3
takeaway: Move one primitive and watch it propagate through every component.
action: Move a token
props:
  - Under a minute
  - Nothing to install
  - The system this site runs on
instructions: "This is the same three-tier token system this site runs on. Move a primitive, change the density, pick a different accent, and watch the decision propagate through the components in real time."
tags:
  - Design Systems
  - Tokens
  - Theming
...
Token architecture is one of the five things I look at when I audit a design system. If you want a quick read on where yours stands, the [design-system scorecard](/tools/scorecard/) has a handful of questions on exactly this. Ten minutes, and you will know whether your tokens are doing real work or just sitting there looking organized.
